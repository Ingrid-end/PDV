...
// Manda dados para o banco
include(dirname(__DIR__,1).'/back-end/clientes/createCliente.php');
?>
<html lang="pt-br">
    <body>
                ...
                <div class="form_index">
                    ...
                    <form method="POST"  action="cadastro_cliente.php">
                        ...
                        <h2 class="font_titulos">Carro:</h2>
                            ...
                            <!-- enviar -->
                            <button class="botao_caixa botao" type="submit" name="enviar_cadastro">CADASTRAR</button>
